...
| カテゴリ | ファイル | 参照タイミング |
|---------|---------|---------------|
| プロジェクト準拠 | `~/.claude/rules/project-conformity.md` | **常時** |
...
**2. コード実装を伴う開発タスクを受けた場合、必ず `~/.claude/rules/development-workflow.md` のフローに従うこと。**
...
| 日付 | バージョン | 変更内容 |
|------|-----------|---------|
| 2026-02-19 | 2.5.0 | プロジェクト準拠ルールを最上位必須ルールとして追加。設定階層の優先順位を明確化 |
| 2026-02-19 | 2.4.0 | ファイル操作ガイドラインを追加 |
